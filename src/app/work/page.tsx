            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center bg-teal-600 hover:bg-teal-500 text-white px-6 py-3 rounded-lg transition-colors font-semibold"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center text-teal-400 hover:text-teal-300 transition-colors group px-6 py-3"
                >
                  View Landing Page
                  <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
