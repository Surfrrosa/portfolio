...
257 passing tests cover calculation accuracy, API contract validation, database operations, email formatting, and retry logic. The infrastructure that means a customer in Tokyo at 3 AM gets the same reliable experience as someone in Brooklyn at noon.
