...
The tests came after things broke in production that shouldn't have broken, after realizing that changing the synthesis prompt could silently degrade output quality in ways that wouldn't surface for days.
