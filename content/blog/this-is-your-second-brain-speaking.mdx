---
title: "This is your second brain speaking."
date: "2026-04-12"
...
Smaller than it sounds. Claude Code retains inputs up to 30 days for abuse monitoring and doesn't train on them by default. Meanwhile your vault syncs to iCloud or Dropbox, your email client leaks more sensitive data than your journal would, and your laptop is as secure as its disk encryption. The "Anthropic employees read my reflections" threat model is mostly imaginary.

The real cases are compliance-shaped. HIPAA-covered data. Attorney-client privilege. Journalistic sources. These categorically can't transit a third-party model, no matter the retention policy.

And in those cases, you don't need a second brain. You need a local model. Ollama or LM Studio plus your own files gets you the AI workflow with no third party in the loop. Different architecture, not a different vault.

Either your threat model doesn't need what you think it does, or it needs something outside this argument entirely.

## so

If you're building one right now, ask which thing you're doing. Solving a retrieval problem, or enjoying the build. Both are fine, and I'm not here to discourage anyone. Hell, I couldn't have wrote this if I didn't do it myself. It was a lot of learning under my belt, so my recommendation is keep going. Experience points are the only thing that really matters in this wild ride anyway.
