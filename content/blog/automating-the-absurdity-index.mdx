...
The pipeline (16 collectors, a deduplicator, a score calculator, a regex TypeScript rewriter, and a CI workflow) runs weekly and produces a working dashboard. The methodology is transparent, the scripts are open-source, and anyone can verify how the scores are calculated.

Not every project needs production-grade infrastructure. Sometimes the right amount of engineering is exactly what the problem calls for, nothing more. The absurdity, after all, compounds faster than any pipeline can track. The best you can do is keep collecting, keep refining, and be honest about how it all works.
