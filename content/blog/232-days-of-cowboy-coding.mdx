...
date: "2026-02-07"
excerpt: "I've been building with AI every day for 232 days. Fourteen repositories, 535 co-authored commits, and a completely different relationship with how work gets done."
readTime: "6 min read"
tags: ["AI Development", "Process", "Claude Code"]
draft: false
---
...
Every project starts with strict, project-specific instructions that get loaded into every session. Don't guess data, verify it computationally. Use this font system, not that one. Read the latest [session log](/writing/the-skill-layer) before starting work and write a session log for your future self before stopping. No exceptions. Without them, consistency drifts and context gets lost in the interim.
