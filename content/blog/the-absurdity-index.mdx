...
This project has been built with AI-assisted development as needed for full-stack development with a close eye to detail and direction. For this, I used Claude Code, my faithful companion.
...
This is meant to be a fun, living research project that I update weekly out of my own curiosity. The asterisk is an open invitation.

---

*The Absurdity Index was sunset in June 2026. The dashboard and code repository are no longer live.*
